...
if platform.system() == "Windows":
	...
	pytesseract.pytesseract.tesseract_cmd = (
		r"C:\Users\hsoriano\AppData\Local\Tesseract-OCR\tesseract.exe"
	)
	...
	out_directory = Path(r"H:\Python\Req_090122(PDF_to_Pandas)\Output").expanduser()
else:
	out_directory = Path("~").expanduser()	

# Path of the Input pdf
PDF_file = Path(r"H:\Python\Req_090122(PDF_to_Pandas)\Input\10Y0026 = BD0282.pdf")

# Store all the pages of the PDF in a variable
image_file_list = []

text_file = out_directory / Path("10Y0026 = BD0282_text.txt")
