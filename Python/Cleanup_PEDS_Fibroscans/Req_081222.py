...
if __name__ == "__main__":
    ...
    df_excel = pd.read_excel(r'U:\Research\BrownsvilleSD\public\Diabetes_Core\Data Request\McCormick\Req 032122( Plasma_DNA_RNA_URINE)\fibroscan\ALL ULTRASOUND for PEDI SPREADSHEET.xlsx',sheet_name='Liver, Carotid & DXA')
    ...
    output[0].to_excel(r'U:\Research\BrownsvilleSD\public\Diabetes_Core\Data Request\McCormick\Req 032122( Plasma_DNA_RNA_URINE)\fibroscan\Correct.xlsx', index = True)
    output[1].to_excel(r'U:\Research\BrownsvilleSD\public\Diabetes_Core\Data Request\McCormick\Req 032122( Plasma_DNA_RNA_URINE)\fibroscan\Errors.xlsx', index = True)
